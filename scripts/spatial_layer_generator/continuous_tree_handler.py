...
def handle_continuous_tree(tree_path, most_recent_tip, location):
    ...
    most_recent_tip_time = get_most_recent_tip_time(most_recent_tip)

    for edge in tree.preorder_edge_iter():
        id += 1
        branch = process_edge(edge, most_recent_tip_time, delimiter, id)
...
def get_edge_times(edge, most_recent_tip_time, branch_length, delimiter):
