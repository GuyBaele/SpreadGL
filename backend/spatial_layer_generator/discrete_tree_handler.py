...
def handle_discrete_tree(tree_path, most_recent_tip, location, location_list):
    ...
    if isinstance(most_recent_tip, str):
        ...
        most_recent_tip_time = most_recent_tip

    for edge in tree.preorder_edge_iter():
        id += 1
        branch = process_edge(edge, most_recent_tip_time, delimiter, id, location, location_pattern, match_quoted_string, location_list, not_root)
...
def process_edge(edge, most_recent_tip_time, delimiter, id, location, location_pattern, match_quoted_string, location_list, not_root):
    ...
    if child_node.is_leaf():
        ...
        ending_time, starting_time = process_leaf_node(child_node, most_recent_tip_time, branch_length, delimiter)
...
def process_leaf_node(node, most_recent_tip_time, branch_length, delimiter):
    ending_time = 0.0
    starting_time = 0.0
    no_height = True
